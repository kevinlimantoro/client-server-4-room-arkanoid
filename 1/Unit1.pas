...
shape2.Hide;
clientsocket1.Socket.SendText(inttostr(shape2.top)+'!'+'0@'+inttostr(x)+'#'+inttostr(y))
end;
if (shape2.top+33>=form1.Height) and (y=10) then
begin
timer1.Enabled:=false;
shape2.Hide;
clientsocket1.Socket.SendText('to1'+'0!'+inttostr(shape2.left)+'@'+inttostr(x)+'#'+inttostr(y));
end
