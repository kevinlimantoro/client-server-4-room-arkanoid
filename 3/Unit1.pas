...
shape2.Visible:=true;
timer1.Enabled:=true;
clientsocket1.Socket.SendText('now3');
end;
end;

procedure TForm1.Timer1Timer(Sender: TObject);
begin
if (shape2.left<=0) and (x=-10) then
begin
timer1.Enabled:=false;
shape2.Hide;
clientsocket1.Socket.SendText('to1'+inttostr(shape2.top)+'!'+inttostr(shape2.left)+'@'+inttostr(x)+'#'+inttostr(y));
end
else if shape2.left+33>form1.width then
begin
x:=-10;
end;
